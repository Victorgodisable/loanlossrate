...
SECRET_KEY = 'django-insecure-78l!^&hbvg7ka336cv5w8pz9z(2d*o)i_4s*nxhj6699bszgrl'
...
#         'NAME': 'estimates',  # Remove leading/trailing spaces from the database name
...
# settings.py
FILE_UPLOAD_MAX_MEMORY_SIZE = 10242880  # Set to your desired max size (e.g., 1 GB)
